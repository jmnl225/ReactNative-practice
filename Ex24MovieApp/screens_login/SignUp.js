        ...
        return(
            <View style={styles.root}>
                ...
                <View style={styles.content}>
                    ...
                    {/* <TabComponent selected={true} lable="전화번호"></TabComponent>
                    <TabComponent selected={} lable="이메일"></TabComponent> */}
                   

                    {/* 1.2 정보 입력창 */}
                    <InputComponent placeholder={this.state.tabs[this.state.tabIndex]}></InputComponent>
                    {/* 1.2.1 이메일 선택했을때 입력창 1개 더 추가 */}
                    {
                    ...
                    {/* 전화번호 탭일때 안내메세지 */}
                    {
                        this.state.tabIndex === 0 && <Text style={styles.telMessage}>Movie App의 업데이트 내용을 SMS로 수신 가능하며, 언제든지 취소할 수 있습니다.</Text>
                    }
